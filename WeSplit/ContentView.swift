...
//  WeSplit
//
//  Created by Nedra Mevoli on 7/21/22.
//
...
struct ContentView: View {
    ...
    var totalPerPerson: Double {
        // I wanted to support the ability to simply calculate how much to tip, even just for a single person order, hence starting at 1
